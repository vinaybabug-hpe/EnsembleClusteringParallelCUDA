...
__device__ void averageVariance(float* fcs_data, float* means, int num_dimensions, int num_events, float* avgvar) {
    ...
    extern __shared__ float variances[];
...
__device__ void compute_constants(clusters_t* clusters, int num_clusters, int num_dimensions/*, float* matrix*/) {
    int tid = threadIdx.x;
 ...
 */
__global__ void
constants_kernel(clusters_t* clusters, int num_clusters, int num_dimensions/*, float* matrix*/) {
    compute_constants(clusters,num_clusters,num_dimensions/*, matrix*/);
...
//    extern __shared__ float means_row[];
//    extern __shared__ float means_col[];
...
//    extern __shared__ float temp_sums[];
