/*
 =====================================================================================================================
 Name        : cluster_util_partition2cam.h
...
#ifndef CLUSTER_UTIL_PARTITION2CAM_H
#define CLUSTER_UTIL_PARTITION2CAM_H
...
/* End of code generation (cluster_util_partition2cam.h) */
