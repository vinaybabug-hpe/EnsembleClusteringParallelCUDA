/*
 =====================================================================================================================
 Name        : cluster_util_indices2centers.cu
...
//	float *x_transpose = (float*) malloc(nSamples * nFeatures * sizeof(float));

//	CUDA_CHECK_RETURN(cudaMemcpy(x_transpose, x_transpose_dev_ptr, nSamples * nFeatures * sizeof(float), cudaMemcpyDeviceToHost));
